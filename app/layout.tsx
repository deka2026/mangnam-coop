        ...
        <footer className="mt-20 border-t border-sea-100 bg-white">
          <div className="container-page py-10 grid gap-8 md:grid-cols-3 text-sm text-sea-700">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li><Link href="/plogging" className="hover:text-sea-900">🧹 플로깅 신청</Link></li>
                <li><Link href="/mulmeong" className="hover:text-sea-900">🌌 별달물멍 스팟예약</Link></li>
          ...
          <div className="border-t border-sea-100">
            <div className="container-page py-5 text-xs text-sea-600 flex flex-wrap justify-between gap-2">
              ...
              <span className="flex flex-wrap items-center gap-3">
                ...
                <Link href="/admin" rel="nofollow" className="inline-flex items-center rounded-full border border-sea-200 px-3 py-0.5 hover:bg-sea-50 hover:text-sea-900">🗂 조합 운영관리</Link>
