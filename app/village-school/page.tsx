...
export const metadata: Metadata = {
  ...
  description:
    "섬에서 다시 시작하는 3박 4일. 고립·은둔·숨고르기 청년을 위한 완도 망남마을의 회복·커뮤니티·취창업 평생교육 프로그램.",
};
...
const PILLARS = [
  {
    icon: "🌊",
    title: "회복",
    body: "인천에서 450km. 당일 복귀가 불가능한 거리가 도시의 일상과 완전히 분리된 4일을 만듭니다. 1인 1침상, 말하지 않아도 되는 시간이 매일 있습니다.",
  },
  {
    icon: "🤝",
    title: "커뮤니티 활동력",
...
const FACTS = [
  ...
  { k: "모집", v: "20명 (개인별 신청)" },
  { k: "대상", v: "만 19~39세 고립·은둔·숨고르기 청년" },
  { k: "참가비", v: "무료 (버스·숙박·식사 전액 지원)" },
  { k: "이동", v: "인천 유유기지 ↔ 완도 전세버스" },
];
    ...
    <>
      ...
      <section className="bg-sea-50 border-b border-sea-100">
        <div className="container-page py-16">
          <p className="text-sea-600 font-semibold">망남마을학교 · 평생교육 프로그램</p>
      ...
      <section className="container-page pb-4">
        ...
        <p className="section-sub">
          인천에는 고립·은둔 상태의 청년이 약 6만 명으로 추정됩니다. 이들에게 부족한 것은
        ...
        <div className="card bg-earth-50 ring-earth-200">
          ...
          <ul className="mt-4 space-y-3 text-sm leading-relaxed text-sea-800">
            ...
            <li>
              ...
              전문적인 치료가 우선 필요한 상태로 확인되면, 원거리 합숙 대신 인천의
